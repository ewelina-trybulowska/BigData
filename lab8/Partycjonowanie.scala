...
initialDF.write.mode("overwrite").parquet("dbfs:/FileStore/tables/pageviews_by_second.parquet")

// COMMAND ----------

val alternateDF = spark.read
  //.format("parquet").load("/mnt/training/wikipedia/pageviews/pageviews_by_second.parquet")
  .format("parquet").load("dbfs:/FileStore/tables/pageviews_by_second.parquet")
...
// MAGIC %fs ls /FileStore/tables/pageviews_by_second.parquet
